...
habituals.endorsement.pred.bars <- m.hab.predictive.endorse.allModels %>%
  mutate(condition = factor(condition, levels = c("preventative", "baseline", "enabling")),
         src =factor(src , levels = c("human data","predictive_model", "regression_pastfreq",
...
ggplot(., 
  ...
  #coord_fixed()+
  ylab("Habitual endorsement")+
  xlab("Item (past frequency: 3 times per interval)")+
  ...
  mutate(condition = factor(condition, levels = c("preventative", "baseline", "enabling")),
         src =factor(src , levels = c("human data", "regression_pastfreq",
                     ...
                     labels= c("Human data","regression_pastfreq", 
                                "Uncertain semantics (Past)", "Linear model (Predictive frequency)","Uncertain semantics (Predictive)"))) %>%
...
plot_grid(
  ...
  plot_grid(
    ...
    labels = c("B", "C"),
    nrow = 1,  axis = 'tblr', rel_widths = c(1, 1.8)), 
  labels = c("A", ""), 
  nrow = 2, align = 'v', axis = 'lr', rel_heights = c(3.1, 1.5))
```
