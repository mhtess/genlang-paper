...
load("cached_results/case2_endorsement_rsaModelResults.RData") #m.hab.endorse.rsa, hab.uncertain.threshold.s1opt, fixed.hab.params.posterior, md.hab.long, hab.listener.predictions
...
In total, `r nrow(md.hab.long %>% select(habitual, time_period) %>% distinct())` unique items were created by pairing frequencies with events. 
