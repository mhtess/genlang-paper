...
#   #                   n_samples, "_burn", burn, "_lag", lg, "_chain", i, ".csv", sep = ""))
#   mi.fixed <- fread(paste(project.path,  "models/habituals/results/",
#                           "results-habituals-jointModel-inferFixedThresholdCts-S1-smtncs_some-100000_burn50000_lag20_chain", i, ".csv", sep = ""))
#   #
...
# save(m.hab.fixed.samp,
#      file = paste(project.path,  "results-habituals-jointModel-inferFixedThresholdCts-noise-S1-smtncs_some-100000_burn50000_lag20_2chains.RData", sep = ""))
...
<!-- The lowest frequency used in our data set was $0.2$ times per year.  -->
<!-- Thus, all of the utterances evaluated under a fixed-threshold model were literally true.  -->
