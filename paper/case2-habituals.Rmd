...
We take event analogue of prevalence to be the *rate* with which the event occurs (e.g., how often Mary smokes).^[
  Specifically, for the generalization "Mary smokes", the instances being generalized are *instances of Mary*, and for the instance to have the feature, it means the instance of Mary is one in which she is smoking.
]
...
Does prevalence represent the actual, objective frequency in the world or the subjective, predictive belief in the head?
We elucidate this aspect of our theory by measuring participants' predictions about future rates and endorsements of habituals when causal forces intervene on the world (Expt. 2c).
...
figure.habituals.priors.scatter <- 
  ...
  geom_label_repel(data = . %>%
                  ...
                  inherit.aes =F, segment.alpha = 1,label.size = 0.25,
                  segment.size = 5,
                  aes(x = `% people who have done action before`, 
           y = `Frequency of doing action (log scale)`, 
           label = item), force = 1, size = 2)+
  coord_fixed(1/7.5)+
