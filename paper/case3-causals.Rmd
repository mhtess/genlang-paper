...
The two cover stories can be seen in Table 1.

Participants were then shown "previous experimental results", which followed one of four distributions, shown in Figure \@ref(figure-causals)B. 
...
The two other conditions used distributions in which some experiments resulted in either no or very few successes (i.e., produced 0s or 1s or 2s), and others that either had strong or weak effects as above. 
...
Participants responded by either clicking "Yes" or "No". 
...
In addition to further demonstrating the generality of this theory, these experiments show that the *prevalence prior* $P(p_{fk})$ is causally related to endorsements of generalizations in language.
...
For example, physical causal systems (e.g., billiard balls hitting each other) could strongly induce near-deterministic notions of causal power, analogous to our "deterministic" priors conditions. 
