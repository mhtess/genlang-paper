...
Figure \ref{fig:causals-endorsement} shows the Bayesian Maximum A-Posteriori (MAP) estimate and 95\% highest probability density interval of the true population probability of endorsing the statement for the different experimentally-manipulated priors and frequencies. 
