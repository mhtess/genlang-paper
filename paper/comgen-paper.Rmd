...
Beliefs about prevalence are often the result of conceptual knowledge about kinds and properties [@Leslie2007; @Leslie2008; @Prasada2013].
Such knowledge is not necessary, however: Relevant background knowledge may be merely correlational in nature.
The prevalence prior is a common statistical layer that provides the glue between conceptual knowledge and natural language semantics.
The truth conditions of generalizations depend only on prevalence, but prevalence depends upon conceptual knowledge.
...
We note, however, that a richer model of the prior was not necessary, at this point, to account for the context-sensitive endorsement patterns we observe in our empirical data. 
...
We distinguish our construct from other uses of *prevalence* in the literature, often taken to be synonymous with observed frequency.
...
The present paper presents the first formal theory of genericity in language that makes accurate and precise quantitative predictions about human behavioral data. 
