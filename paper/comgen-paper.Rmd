...
\mht{this "surprising prediction" might set the reader up for the expectation that we are going to test this prediction..}
...
That is, our theory predicts there are situations where statements like (8) could be considered felicitous generalizations.
...
Our view of understanding generalizations involving reasoning about an uncertain threshold is reminiscent of @Williamson1994's epistemicist view on vagueness.
...
@Leslie2008 argues that the necessary complexity of a formal account of generics and the simplicity with which young children acquire generics implies that the normal tools for describing the semantics of quantified utterances (e.g., a truth-functional threshold) are inappropriate for generics.^[
  This argument is a little too simplistic in that it ignores evidence that children's struggle with quantifiers stems from pragmatic issues [@Musolino2006].
]
