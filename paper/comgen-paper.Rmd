...
Hence, generic statements are a diverse class, and the conceptual view highlights this diversity [e.g., @Prasada2013].
...
Formalizing such a theory is scientifically useful as well to make explicit the assumptions of the psycho--linguistic hypothesis meant to match human intuitions, which in turn, elucidates the conditions under which the theory may be meaningfully tested. 
...
The specific exemplars can be objects (a dog), events (a coffee drink), or more fine grained types (a person on a given day).
The properties can vary greatly (e.g., having fur, causing jitters, typing). 
Yet the prediction for the new exemplar can be described as a *predictive probability*, which we will denote throughout the paper as $h$ and refer to as the **feature-probability**: 
