...
#model_prefix <- "results-habituals-predictive-jointModel-predMin-3-S1-smtncs_habitual-"
n_samples <- 100000
burn <- n_samples / 2
lg <- 20
...
# m.hab.pred.samp <- fread(paste(project.path,
#                                 "models/habituals/results/",
#                                 "results-habituals-predictive-meanPredictive-min-5-jointModel-S1-smtncs_habitual-targetH_predictive-10000_burn5000_lag20_chain1.csv",
#                                 sep = ""))
