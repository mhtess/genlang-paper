...
If generalization from observations can be described using probability, then it seems very natural to consider the semantic content of generalizations in language as relating to probability. 
One very simple semantic theory that has been used for describing quantified statements is a *threshold semantics*:
...
\ndg{move all this background about generics earlier, so that this section can go straight to our model.}
