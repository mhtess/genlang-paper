...
The knowledge that an object tends to have a property, an entity tends to exhibit a behavior, or a cause tends to produce an effect can be crucial in an uncertain world.
Such *generalizations* can be acquired by drawing inductive inferences from observations [@Baldwin1993; @Xu2008; @Dewar2010]. /ndg{older cites for this? hume?}
