...
We note that regressions model that takes into account the referent prevalence and the distinctiveness of the feature do reasonable jobs at explaining some of the variance in the endorsement data.
This kind of model, however, is merely a re-description of the data and does not represent a bonafide theory of the semantics of a generalization. 
