...
Despite its ubiquity and relative morphosyntactic simplicity, the language of generalization has been addressed by few formal models and none that have made precise, quantitative predictions that match human judgements. 
The major challenge in formalizing generalization in language is determining what makes the statements seem true or false.
...
Generic statements are instead thought to refer to *kinds* [@Leslie2008] and thus may be the linguistic manifestation of special, kind--property relations [@Prasada2000; @Prasada2012]. 
...
The assumptions of the theory and the conditions under which the theory may be meaningfully tested are made explicit by its instantiation in a formal model.
...
In Section 1, we formalize the hypothesis that the core meaning of a generalization in language is a simple but underspecified threshold on a subjective probability, articulate a theory of relevant background knowledge used to understand a generalization in context, and use these components to develop a computational model of endorsement.
...
We find a very strong agreement of our model's predictions to the full spectrum of human elicited endorsements, while alternative models fall short.
