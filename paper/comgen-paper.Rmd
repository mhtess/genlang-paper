...
Figure\ \@ref(fig:simulations) shows the listener model $L$'s posterior distribution on prevalence $h$ upon hearing utterances corresponding to the uncertain threshold (Eq. \ref{eq:L0}) as well as a comparison model using a fixed threshold at 0 (intuitively, corresponding to the quantifier "some").
The differences in the semantics are easily seen when considering a uniform prior distribution over $h$ (Figure\ \@ref(fig:simulations); top row).
