...
Relying upon observations would be particularly problematic, for example, to learn about properties that are costly to observe (e.g., *starting at the sun makes you go blind*) or events that are statistically rare (e.g., *lightning strikes tall objects*).
...
Contrary to these accounts, in our model, conceptual structure is represented in listeners' knowledge of the world $P(h)$ and not in the semantic content of the utterance $u$.
...
Here, we see that listener's posterior upon hearing the generalization (the uncertain threshold) is similar to what she learns about hearing "Some mosquitos carry malaria" (the fixed threshold; Figure\ \@ref(fig:simulations) row 4). 
