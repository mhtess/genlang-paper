...
Minimally, language fosters generalizations by bringing attention to objects being of the same kind through the use of labeling [e.g., "This is a bird."; @Gelman1986; @Gopnik2000; @Graham2004; @Markman1989; @Schulz2008].
Objects have many properties though; when speakers attach kind-labels to properties (e.g., *Birds fly*), listeners hear a *generalization*.
