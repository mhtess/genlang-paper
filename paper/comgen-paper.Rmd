...
Once learners have the capacity to infer the intention of other cooperative agents, social learning can dramatically faciliate inductive reasoning [@Csibra2009; @Tomasello1999; @Butler2012].
...
Speakers can talk about categories generically (*generic language*; e.g., *Dogs bark*), individual people in generalizations (*habitual language*; e.g., "Mary swims after work."), causal events in generalizations (*causal language*; e.g., "Drinking moonshine makes you go blind."), and people in general [e.g., "You never know what will happen on a blind date."; @Orvell2017].
...
]; the statement should signal something weaker like *Most* dogs bark.
