...
worked.examples <- data.frame(
  ...
  `potential issue` = c(
    ...
    "Only female (50%) of robins lay eggs",
    "Roughly same number of robins that lay eggs are female",
    "Very few mosquitos actually carry malaria",
    "Hypothetically, there has never been any mail from Antarcita",
    "Even if 100% have even social security numbers",
    "Impossible for most to live in Africa and most to live in Asia"
  )
)

examples <- xtable::xtable(worked.examples, 
                       caption = "Example generalizations that a theory of generics should correctly predict.", 
                       align=c('p{1.5in}', 'p{1.2in}| ',' |p{1in}|','p{1in}|','p{2in} |'))
