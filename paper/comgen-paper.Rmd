...
Generalizations are not limited to generics, however; they can be found in statements about individuals (*habitual language*; e.g., "Mary swims after work.") as well as causal events (*causal language*; e.g., "Staring at the sun makes you go blind.").
...
A formal model in this domain is advantageous to make explicit the relevant assumptions of a psychological or linguistic hypothesis for predicting human behavior; this, in turn, makes the theory more falsifiable. 
...
However, less than 1\% of moquitos actually carry malaria and still "Mosquitos carry malaria" is intuitively true.
...
That same half of robins (i.e., the females), however, also lay eggs, and "Robins lay eggs" is intuively reasonable. 
...
With this perspective, @Leslie2007 proposes generics express a cognitively primitive, default generalization. 
...
This theory correctly predicted that generics that convey striking properties would be true even if the property were relatively rare [e.g., "Sharks attack swimmers"; @Cimpian2010; @Prasada2013].
...
Arbitrary relationships can also be expressed with generics (e.g., "Barns are red"; "Ravens are bigger than toasters") which seem only to be true because those are the statistics of the world [@Nickel2008; @Nickel2016; @Sterken2015].
...
The diversity of generic statements highlighted by this view is interesting, but insofar as generics are a single, unified phenomenon, there should be a general, unified principle that explains what makes the statements true or false.
