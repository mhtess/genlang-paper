...
The fixed-threshold model is a lesioned version of the unceratin-threshold model: It has access to the full prior distribution on feature-probabilities $P(h)$ and models endorsement as an information-theoretic decision of producing the generic vs. an alternative.
...
#model_prefix <- "results-generics-jointModel-10bins-S1-smntcs_"

#m.samp <- fread(paste(project.path,  "models/generics/results/", model_prefix, "generic-",
                     #20000, "_burn", 10000, "_lag", 20, "_chain", 2, ".csv", sep = ""))
#m.samp <- fread("~/Documents/research/communicating-generalizations/models/generics/results/results-fullModel-s1-allowUPriors-refinedPriors-fixedNull-prevPriorFactorBugFixed-smtncsgeneric-100000_burn100000_chain1.csv")
