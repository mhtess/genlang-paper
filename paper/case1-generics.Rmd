...
Generalizations about categories (i.e., *generic language*; e.g., "Dogs bark.") are of substantial interest in psychology for their role in concept and theory formation [e.g., @Gelman2004], stereotype propagation [@Rhodes2012], motivation [@Cimpian2007], and many other facets of everyday reasoning.
...
They were asked to press one of two buttons (randomized between-participants) to signify whether they agreed or disagreed with the sentence (see Figure\ \@ref(fig:generics-endorsement-figure)A for the full list). 
