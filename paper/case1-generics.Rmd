...
generics.endorsement.insets <- ggplot( gen.inset.distributions.refactored %>%
         mutate(Parameter = factor(Parameter, levels = c("state_Prior", "state_Posterior", "speakerBeliefs"),
                                   labels = c("Null interpretation\n(Prevalence prior)", "Generic interpretation\n(model)", 
                                              "Referent prevalence")),
                property = factor(property, levels = c("have spots", "lay eggs", "are female", "carry malaria", "dont eat people"))),
       aes(x = state, y = Parameter, group = Parameter ))+
