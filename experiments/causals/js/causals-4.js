      ...
      if (this.count == (this.experimentNames.length - 1)) {
        ...
        if (this.waitFlag == 1) {
          ...
          if (exp.condition == "prior"){
            ...
            $(".question0").html("The experiment using "+ this.stim.targetTreatment + " is not finished yet.<br>When it finishes, how many of the attempted 100 "+this.stim.unit + " will be " + this.stim.past + "?");
            $(".question0").show();
